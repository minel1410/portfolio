  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col mt-3 gap-24 w-full">
        ...
        >
          <FeaturedProjectCard
            cardTitle="My Personal Drive"
            cardDescription="A personal cloud storage solution built and hosted on my own server for full control. Developed the frontend with Next.js and Shadcn for a modern UI, and the backend with FastAPI for efficient file management. Automated photo uploads from my phone and hosted the app on Vercel with SSL certification for secure access."
            backgroundImage="/drive.png"
            githubLink="https://github.com/minel1410/my_drive"
            hostedLink="https://drive.minelsalihagic.com/"
            technologies={[
              "FastAPI",
              "Next.js",
              "Shadcn",
          ...
          >
            <FeaturedProjectCard
              cardTitle="Beauty Salon Website"
              cardDescription="I created a website for a beauty salon in Germany using Next.js. The site is hosted on Vercel and optimized for SEO to improve search engine rankings. It also features an API endpoint and a form through which visitors can book appointments, with the bookings processed via the Next.js API. The website offers users an easy and fast way to schedule services online."
              backgroundImage="/beauty_salon.png"
              githubLink="https://github.com/minel1410/arnelasbeauty"
              hostedLink="https://arnelasbeauty.com"
              technologies={[
                "React.js",
                "Vercel",
                "Web design",
      ...
      <div className="w-full flex flex-col gap-5 mt-12">
        ...
        >
          <ProjectCard
            ...
            githubLink="https://github.com/minel1410/portfolio"
          />
          ...
          <ProjectCard
            ...
            githubLink="https://github.com/minel1410/car-price-predictor-model"
          />
          <ProjectCard
            ...
            githubLink="https://github.com/minel1410/fastestMazeExit"
          />
          ...
          <div className="xl:hidden">
            <ProjectCard
              ...
              githubLink="https://github.com/minel1410/matrix_operations"
            />
          </div>
        </motion.div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-5">
              ...
              >
                <ProjectCard
                  ...
                  githubLink="https://github.com/minel1410/car-price-predictor-api"
                />
              </motion.div>
              <motion.div
                variants={cardVariants}
              ...
              >
                <ProjectCard
                  ...
                  githubLink="https://github.com/minel1410/WordleClone"
                />
              </motion.div>
              <motion.div
                variants={cardVariants}
              ...
              >
                <ProjectCard
                  ...
                  githubLink="https://github.com/minel1410/WordleAPI"
                />
              </motion.div>
              <motion.div
                variants={cardVariants}
              ...
              >
                <ProjectCard
                  ...
                  githubLink="https://github.com/minel1410/registar_sredstava_api"
                />
              </motion.div>
              <motion.div
                variants={cardVariants}
              ...
              >
                <ProjectCard
                  cardTitle="Autopia"
                  cardDescription="A web app based on API from olx.ba. Designed as an infinite scroll of car ads, simillar to TikTok"
                  technologies={["Next.js", "API", "Web design"]}
                />
              </motion.div>
            </div>
          )}
